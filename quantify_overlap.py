...
for paxregion in pax_region_list:
    ...
    if paxregion == "Lateral Accumbens shell":
        
        summary = "Z:/NESYS_Lab/PostDoc_project_Bjerke/Manuscripts/WHSv4_Basal ganglia/04_Material/quantitative_overlap_analysis/" + paxregion + "_summary.xlsx"
        ...
        plt.savefig("Z:/NESYS_Lab/PostDoc_project_Bjerke/Manuscripts/WHSv4_Basal ganglia/04_Material/quantitative_overlap_analysis/" + paxregion + '_pie.svg', bbox_inches='tight', pad_inches=0.05, dpi=600)
        plt.show()
